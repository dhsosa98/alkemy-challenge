              ...
              <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className={`mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full ${(type==="delete") ? "bg-red-100" : "bg-green-100"} sm:mx-0 sm:h-10 sm:w-10`}> 
                      {type==="delete" ? <ExclamationIcon className="h-6 w-6 text-red-600" aria-hidden="true" /> : <BadgeCheckIcon className="h-6 w-6 text-green-600" aria-hidden="true"  />}
                    </div>
